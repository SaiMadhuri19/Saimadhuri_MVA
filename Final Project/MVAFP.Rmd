...
pca_result <- prcomp(auto_mpg_scaled,scale=TRUE)
...
num_clusters <- 2
kmeans_model <- kmeans(auto_mpg_scaled, centers = num_clusters)
...
fviz_cluster(kmeans_model, data = auto_mpg_scaled, geom = "point", frame.type = "convex", 
...
sil <- silhouette(kmeans_model$cluster, dist(auto_mpg_scaled))
...
#LDA generally won't have any residuals
...
#This model gives 84% accuracy for the autompg dataset with high-mpg and low-mpg labels which is a good sign.
