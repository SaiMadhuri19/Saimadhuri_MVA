...
#The residual deviance (206.80) represents the deviance after fitting the logistic regression model with the predictor variables. Smaller residual deviance indicates good fit.
